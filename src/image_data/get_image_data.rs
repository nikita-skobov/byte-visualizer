...
pub fn get_image_data_from_sprites(
    ...
    for sprite in sprite_vec {
        ...
        for i in 0..sprite.pixel_data_max_len {
            ...
            image_data[pixel_index + zlib_offset + 2] = new_blue;
            image_data[pixel_index + zlib_offset + 3] = new_alpha;
        }
    }
...
//     let vector_size = num_pixels * super::pixels::VALUES_PER_PIXEL as i128;
//     let zlib_vector_size = vector_size + width as i128;
//     println!("zlib vector size: {}", zlib_vector_size);
//     let mut image_data: Vec<u8> = vec![0; vector_size as usize];
...
//             let pixel_index: i128 = height_offset as i128 + width_index as i128;
//             let pixel_index: i128 = pixel_index as i128 * super::pixels::VALUES_PER_PIXEL as i128;
//             let pixel_index: usize = pixel_index as usize;
...
//             let zlib_offset = 1 + (pixel_index / pixels_per_row as usize);
//             println!("green: {}, pixel index: {}, zlib offset: {}", new_green, pixel_index, zlib_offset);
//             image_data2[pixel_index + zlib_offset] = new_red;
//             image_data2[pixel_index + zlib_offset + 1] = new_green;
//             image_data2[pixel_index + zlib_offset + 2] = new_blue;
//             image_data2[pixel_index + zlib_offset + 3] = new_alpha;
//         }
//     }

//     println!("image data2: {:?}", image_data2);
//     image_data
// }
