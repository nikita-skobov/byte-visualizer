...
pub fn write_rgba_from_u8<W: ::std::io::Write>(
    ...
    {
        // this block was commented by Nikita Skobov
        // it creates a deep copy of the image data which doubles the memory usage
        // as well as the time it takes to save the image.
        // if the image data is already formatted in a way that fake_zlib can
        // "compress" it, then we save a lot of memory and time.
        ...
        png_pack(file, b"IDAT", &fake_zlib::compress(&image))?;
    }
...
// Commented out by Nikita Skobov
